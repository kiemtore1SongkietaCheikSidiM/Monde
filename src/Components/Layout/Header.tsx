...
// var to take the user data
const user = auth.currentUser

//const to take all the notification
        ...
        <header className="border-b border-slate-200/50 bg-white/80 px-3 py-3 backdrop-blur-xl dark:border-slate-700/80 dark:bg-slate-900/80 sm:px-4 md:px-5 lg:px-8">
            <div className="flex flex-wrap items-center justify-between gap-3 md:gap-4">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    {/* Action button to make the user be able to set something */}
                    ...
                    {/* Button for setting which redirect you to the setting page */}
                    ...
                    {/* An button for small info about the user */}
