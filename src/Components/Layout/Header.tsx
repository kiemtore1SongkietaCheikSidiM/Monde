            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className=' md:blok'>
                        ...
                        <p className="font-medium text-slate-800 dark:text-zinc-300">Bienvenue dans notre reseau {user?.displayName}</p>
                    </div>
                </div>
                ...
                <div className='flex items-center space-x-3'>
                   ...
                   <button className='relative p-2.5 rounded-xl text-slate-800 dark:text-slate-300
                    hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors' aria-label="Notification">
                    ...
                    <div className='flex items-center space-x-3 pl-3 border-l border-slate-200 dark:border-slate-700'>
                        ...
                        <div className='hidden md:block'>
                            <p className='text-sm font-medium text-slate-500
                             dark:text-slate-400'>{user?.displayName}</p>
