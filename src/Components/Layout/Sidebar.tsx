...
const Sidebar = ({ sidebarcollaps, ontoggle }: Search) => {
  ...
  return (
    <aside
      className={`flex flex-col border-r border-slate-200/50 bg-white/80 backdrop-blur-xl transition-all duration-300 ease-in-out dark:border-slate-700/50 dark:bg-slate-900/80 ${!sidebarcollaps ? "w-20 md:w-22 lg:w-24" : "w-64 md:w-68 lg:w-72"} relative z-10`}
    >
